...
// Heavy-tax Germany charges 20%; protected-share law prevents full disinheritance.
{
  ...
  assert.equal(estate.tax, Math.max(0,estate.gross-estate.rules.exemption)*.75*estate.rules.taxRate);
  assert.equal(estate.distributable, estate.gross-estate.tax);
